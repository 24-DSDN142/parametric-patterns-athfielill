...
This documeDEVELOP_GLYPHnt contains everything you need to work with the wallpaper framework. All of the functions mentioned here can be found in [my_wallpaper.js]
